...
segment data use32 class=data
    ...
    l equ ($-s)/2
    d times l dd 0
    ; d should become 01020304h, 05060708h, 0A0B0C0Dh or "01 02 03 04 05 06 07 08 0A 0B 0C 0D" in memory
    cifra1 db 0
    cifra2 db 0
    cifra3 db 0
    cifra4 db 0
...
segment code use32 class=code
    ...
    parcurgeSirul:
        ...
        lodsw         ; puts in ax, ecx th element from the string
        ...
        stosb
        mov al, [cifra1]
        stosb            ;stores the sorted numbers in the new string     
        dec ecx
